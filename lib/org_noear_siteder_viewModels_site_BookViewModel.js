 ...
 * Description:
 */
var BookSdViewModel = require('./org_noear_siteder_dao_engine_sdVewModel_BookSdViewModel');
...
class BookViewModel extends BookSdViewModel {
    constructor(s, n) {
        ...
        this._lastLook = 0; // 根据url 生成 haskcode
        this.source = s;
        this.node = n;
        this.intro = '';
        this.isSortUp = false;
        this.isDownding = false;
        this.downList = null; // hashcodeList
        this._dtype = -1;
        this._sectionDownList = [];
        this._sectionUpList = [];
        this.lastLookUrl = null;
        this.lastLookUrlPage = null;
    }
